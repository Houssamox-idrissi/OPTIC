                                    ...
                                    <tbody style={{ fontFamily: 'monospace' }} className="text-white bg-slate-900 text-base text-center font-bold">
                                        {filteredCommands.map((command) => (
                                          ...
                                          <td className="py-3 px-2 text-center whitespace-nowrap">
                                              <span className="font-medium">{command.id || <span className="text-red-500">Non disponible</span>}</span>
                                          </td>
                                      
                                          {/* Clients' Nom */}
                                          <td className="py-3 px-6 text-center">
                                              {command.clients.length > 0 ? (
                                                  command.clients.map((client) => (
                                                      <div key={client.id}>
                                                          <span className="block text-base">{client.nom || <span className="text-red-500">Non disponible</span>}</span>
                                                      </div>
                                                  ))
                                              ) : (
                                          ...
                                          <td className="py-3 px-6 text-center">
                                              {command.clients.length > 0 ? (
                                                  command.clients.map((client) => (
                                                      <div key={client.id}>
                                                          <span className="block text-base">{client.prenom || <span className="text-red-500">Non disponible</span>}</span>
                                                      </div>
                                                  ))
                                              ) : (
                                                  <span className="text-red-500">Non disponible</span>
                                          ...
                                          {/* Medecin */}
                                          <td className="py-3 px-6 text-center">
                                              <span>{command.medecin || <span className="text-red-500">Non disponible</span>}</span>
                                          </td>
                                      
                                          {/* Prix */}
                                          <td className="py-3 px-6 text-center">
                                              <span>{command.prix ? `${command.prix} DH` : <span className="text-red-500">Non disponible</span>}</span>
                                          </td>
                                      
                                          {/* Date */}
                                          <td className="py-3 px-6 text-center">
                                              <span>{command.date || <span className="text-red-500">Non disponible</span>}</span>
                                          </td>
                                          ...
                                          <td className="py-3 px-6 text-center">
                                              <button onClick={() => handleStatusChange(command.id, command.status)}>
                                                  ...
                                                  >
                                                      ...
                                                      {command.status ? (command.status === 'Done' ? 'Terminé' : 'En attente') : <span className="text-red-500">Non disponible</span>}
                                                  </span>
                                              </button>
                                          </td>
                                          ...
                                          <td className="py-3 px-6 text-center">
                                              ...
                                              >
                                                  {command.reste !== null ? (Number(command.reste) === 0 ? 'Payé' : 'Non payé') : <span className="text-red-500">Non disponible</span>}
                                              </span>
                                          </td>
                                ...
                                <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="text-gray-700">
                                        ...
                                        <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                            <strong>Medecin:</strong> {selectedCommand.medecin || <span className="text-red-600">⛔ Null</span>}
                                        </div>
                                        <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                            <strong>Date:</strong> {selectedCommand.date || <span className="text-red-600">⛔ Null</span>}
                                        </div>
                                        <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                            <strong>Prix:</strong> {selectedCommand.prix ? `${selectedCommand.prix} DH` : <span className="text-red-600">⛔ Null</span>}
                                        </div>
                                        <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                            <strong>Avance:</strong> {selectedCommand.avance ? `${selectedCommand.avance} DH` : <span className="text-red-600">⛔ Null</span>}
                                        </div>
                                        <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                            <strong>Remise:</strong> {selectedCommand.remise ? `${selectedCommand.remise} DH` : <span className="text-red-600">⛔ Null</span>}
                                        </div>
                                        <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                            <strong>Reste:</strong> {selectedCommand.reste ? `${selectedCommand.reste} DH` : <span className="text-red-600">⛔ Null</span>}
                                        </div>
                                        <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                            <strong>Description:</strong> {selectedCommand.notes || <span className="text-red-600">⛔ Null</span>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-gray-700">
                                        ...
                                        {selectedCommand.clients.map(client => (
                                            <div key={client.id} className="mb-4">
                                                <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                    <strong>Nom:</strong> {client.nom || <span className="text-red-600">⛔ Null</span>}
                                                </div>
                                                <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                    <strong>Prénom:</strong> {client.prenom || <span className="text-red-600">⛔ Null</span>}
                                                </div>
                                                <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                    <strong>Assurance:</strong> {client.assurance || <span className="text-red-600">⛔ Null</span>}
                                                </div>
                                                <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                    <strong>Téléphone:</strong> {client.telephone || <span className="text-red-600">⛔ Null</span>}
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="text-gray-700 mb-6 items-center">
                                    ...
                                    {selectedCommand.glasses.map(glass => (
                                        <div key={glass.id} className="mb-4">
                                            <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                <strong>Type Verre:</strong> {typeVerres.find(type => type.id === glass.type_verre_id)?.libelle || <span className="text-red-600">⛔ Null</span>}
                                            </div>
                                            <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                <strong>Monture:</strong> {glass.nature_de_glasse || <span className="text-red-600">⛔ Null</span>}
                                            </div>
                                            <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                <strong>Vision:</strong> {glass.vision || <span className="text-red-600">⛔ Null</span>}
                                            </div>
                                            <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                <strong>Fournisseur:</strong> {fournisseurs.find(fournisseur => fournisseur.id === glass.fournisseur_id)?.marque || <span className="text-red-600">⛔ Null</span>}
                                            </div>

                                            <div className="text-base" style={{ fontFamily: 'monospace' }}>
                                                <strong>OD:</strong> {glass.od_sph} sph, {glass.od_cyl} cyl, {glass.od_axe} axe, {glass.od_addition ? glass.od_addition : <span className="text-red-600">⛔ Null</span>} addition
                                            </div>

                                            <div className="text-base mt-2" style={{ fontFamily: 'monospace' }}>
                                                <strong>OG:</strong> {glass.og_sph} sph, {glass.og_cyl} cyl, {glass.og_axe} axe, {glass.og_addition ? glass.og_addition : <span className="text-red-600">⛔ Null</span>} addition
                                            </div>
